...
const Headline = React.memo(forwardRef(({
    isWideScreen, 
    device, contentType, widthCat, height, width
  }, ref) => {
  const [imageLoaded, setImageLoaded] = useState(false);
  const videoSrc = `${process.env.PUBLIC_URL}/assets/videos/about_us/About_Us_1902x936_Desktop.mp4`;
  const videoMobileSrc = `${process.env.PUBLIC_URL}/assets/videos/about_us/About_Us_1080x1920_Mobile.mp4`;
  const imageSrc = contentType === 'desktop' ? `${process.env.PUBLIC_URL}/assets/videos/about_us/About Us_1902x936_L_Image Fallback.jpg` : `${process.env.PUBLIC_URL}/assets/videos/about_us/About Us_10802x1920_P_Image Fallback.jpg`
  const propsToPass = {
    height, width,
    widthCat,
    isWideScreen, 
